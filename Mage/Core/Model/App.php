 ...
 * Magento Application
 * 
 * A patched version of the Magento application. This has been extended to provide public setters for
 * the internal protected member variables $_request & $_response. This allows us to set these objects
 * at runtime to facilitate functional testing in a similar manner to standard Zend Framework application.
 * 
 * This patched version of Mage_Core_Model_App will need to be updated between releases of Magento as it will
 * block the upgrade path of the Magento core.
 *
 * @category    Mage
 * @package     Mage_Core
