<?php
/**
 * Magento Admin Session
 * 
 * A patched version of the Magento admin session. This has been patched to use the Response object
 * for the redirection rather then the direct header call
 * 
 * This patched version of Mage_Admin_Model_Session will need to be updated between releases of Magento as it will
