 ...
 * Varien Front
 * 
 * A patched version of the Varien Controller.
 * 
 * This patched version of Mage_Core_Controller_Varien_Front will need to be updated between releases of Magento as it will
